...
public class StartFragment extends Fragment {
    ...
    private ImageButton mImgGoogle,mImgEmail;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mImgGoogle = (ImageButton) getActivity().findViewById(R.id.start_fragment_img_google);
        mImgEmail = (ImageButton) getActivity().findViewById(R.id.start_fragment_img_email);
        ...
        mImgEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
